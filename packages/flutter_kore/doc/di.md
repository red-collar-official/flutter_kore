...
If you are inside any `KoreInstance`, you can connect parts via the `parts` field in the configuration object.
...
Then you can get the instance with the `useLocalInstance` method.
