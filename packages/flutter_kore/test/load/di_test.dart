  ...
  group('Instance collection load tests', () {
    ...
    test('Instance get load test', () async {
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        final _ = instances.get<TestBaseKoreInstance700>();
    ...
    test('Instance getUnique load test', () async {
      ...
      for (var i = 0; i < iterations; i++) {
        final stopwatch = Stopwatch()..start();
        final _ = instances.getUnique<TestBaseKoreInstance700>();
    ...
    test('Instance getUniqueByTypeString load test', () async {
      ...
      for (var i = 0; i < iterations; i++) {
        final stopwatch = Stopwatch()..start();
        final _ = instances.getUniqueByTypeString('TestBaseKoreInstance$i');
    ...
    test('Instance getByTypeString load test', () async {
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        final _ = instances.getByTypeString(type: 'TestBaseKoreInstance$i');
