...
///  ```dart
/// void example() {
///   final subscription = EventBus.instance.listenToCollection([TestEvent1, TestEvent2]).listen((event) {
///     // do something with events
///   });
///
///   EventBus.instance.send(TestEvent1(date: DateTime.now()));
///
///   subscription.cancel();
/// }
/// ```
