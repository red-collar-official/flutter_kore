...
class SyncFuture {
  ...
  ///
  /// Used by [SynchronizedKoreInstance] to decide if this operation must be canceled
...
///
/// It contains internal operations queue and option to cancel remaining oprations when [BaseKoreInstance.dispose] called
///
/// ```dart
...
/// }
/// ```
mixin SynchronizedKoreInstance<Input> on KoreInstance<Input> {
