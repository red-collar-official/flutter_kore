...
class InstanceCollection {
  final container = ScopedContainer<BaseKoreInstance>();
  ...
  List<BaseKoreInstance> all(String scope) => container.all(scope);

  /// Method to remove instances that is no longer used
  ///
  /// Called every time [BaseBaseKoreInstance.dispose] called for instance
  void prune() {
  ...
  List<BaseKoreInstance> getAllByTypeString(String scope, String type) {
  ...
  void addBuilder<KInstance extends BaseKoreInstance>(Function builder) {
  ...
  @visibleForTesting
  void addTest<KInstance extends BaseKoreInstance>({
    String scope = BaseScopes.global,
    required BaseKoreInstance instance,
    dynamic params,
  ...
  KInstance constructInstance<KInstance extends BaseKoreInstance>(String id) {
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  Future<KInstance> getAsync<KInstance extends BaseKoreInstance>({
    DefaultInputType? params,
    int? index,
    String scope = BaseScopes.global,
    bool withoutConnections = false,
  }) {
    return getWithParamsAsync<KInstance, DefaultInputType?>(
      params: params,
      index: index,
      scope: scope,
  ...
  /// [params] - params for this instance
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [beforeInitialize] - callback to run before [BaseKoreInstance.initialize] call
  Future<BaseKoreInstance> getUniqueByTypeStringWithParamsAsync<InputState>({
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  Future<BaseKoreInstance> getByTypeStringWithParamsAsync<InputState>({
    required String type,
    InputState? params,
    int? index,
    String scope = BaseScopes.global,
  ...
  ///
  /// Also calls [BaseKoreInstance.initialize] for this isntance
  ///
  /// [type] - string type of this instance
  /// [index] - index for this instance
  /// [scope] - string scope to get instance from
  ...
  Future<void> addWithParamsAsync<InputState>({
    ...
    final newInstance = builder!() as BaseKoreInstance;
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  KInstance getUnique<KInstance extends BaseKoreInstance>({
    DefaultInputType? params,
    bool withoutConnections = false,
  }) {
    return getUniqueWithParams<KInstance, DefaultInputType?>(
      params: params,
      withoutConnections: withoutConnections,
    );
  }
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  KInstance get<KInstance extends BaseKoreInstance>({
    DefaultInputType? params,
    int? index,
    String scope = BaseScopes.global,
    bool withoutConnections = false,
  }) {
    return getWithParams<KInstance, DefaultInputType?>(
      params: params,
      index: index,
      scope: scope,
      withoutConnections: withoutConnections,
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  KInstance getWithParams<KInstance extends BaseKoreInstance, InputState>({
    InputState? params,
    int? index,
    String scope = BaseScopes.global,
    bool withoutConnections = false,
    ...
    return getInstanceFromCache<KInstance>(
      runtimeType,
      params: params,
      index: index,
      scopeId: scope,
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [beforeInitialize] - callback to run before [BaseKoreInstance.initialize] call
  BaseKoreInstance getUniqueByTypeStringWithParams<InputState>({
    required String type,
    InputState? params,
    bool withoutConnections = false,
    void Function(dynamic)? beforeInitialize,
  ...
  /// [params] - params for this instance
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  BaseKoreInstance getUniqueByTypeString(
    String type, {
    DefaultInputType? params,
    bool withoutConnections = false,
  }) {
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  BaseKoreInstance getByTypeStringWithParams<InputState>({
    required String type,
    InputState? params,
    int? index,
    String scope = BaseScopes.global,
  ...
  /// [withoutConnections] - flag indicating that instance dependencies won`t be connected
  /// [params] - params for this instance
  BaseKoreInstance getByTypeString({
    required String type,
    DefaultInputType? params,
    int? index,
    String scope = BaseScopes.global,
  ...
  /// Adds instance in collection
  ///
  /// Does not call [BaseKoreInstance.initialize] for this isntance
  ///
  /// [type] - string type of this instance
  /// [index] - index for this instance
  /// [scope] - string scope to get instance from
  ...
  KInstance constructAndInitializeInstance<KInstance extends BaseKoreInstance>(
    String id, {
    dynamic params,
    bool withNoConnections = false,
    void Function(dynamic)? beforeInitialize,
  ...
  Future useAndDisposeInstance<T extends BaseKoreInstance>(
