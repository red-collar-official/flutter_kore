...
// class TempAssetWriter implements TestReaderWriter {
//   @override
...
//     return (await PackageAssetReader.currentIsolate()).canRead(id);
//   }
...
//   ReaderWriterTesting get testing => throw UnimplementedError();
// }
